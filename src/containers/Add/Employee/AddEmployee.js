    ...
    render(){
        return(
            <View style={{
                ...
                flexDirection: 'row', justifyContent: 'space-between', fontSize: 16, borderBottomWidth: 0.5, alignItems: 'center'
            }}>
    ...
    static navigationOptions = () => ({
        ...
        headerTitle: () => (
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                <Text style={{ color: 'white', fontSize: 18, paddingLeft: 40 }}>Thêm nhân viên</Text>
            </View>
